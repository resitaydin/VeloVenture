...
AMyProjectSportsCar::AMyProjectSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UMyProjectSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UMyProjectSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UMyProjectSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UMyProjectSportsWheelRear::StaticClass();
